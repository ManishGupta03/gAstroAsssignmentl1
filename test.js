...
// jest.mock('./Queue/queueManager', () => ({ __esModule: true, default: { add: jest.fn().mockResolvedValue('Request enqueued'), },}));
...
describe('API Endpoints', () => {
  it('should enqueue a request', async () => {
    ...
    expect(createClientQueue.add).toHaveBeenCalledTimes(1); // Ensure the add function is called once
  });
